              ...
              child: Column(
                children: [
                  ...
                  _LandingServices(
                    key: _servicesKey,
                    isMobile: isMobile,
                    onServiceTap: (service) => context.push('/service/${service.name}'),
                  ),
                  _LandingHowItWorks(
                    key: _howItWorksKey,
                    isMobile: isMobile,
      ...
      child: Row(
        children: [
          ...
          ElevatedButton(
            ...
            child: Row(
              children: [
                const Icon(Icons.flash_on_rounded, size: 18, color: Color(0xFF090D16)),
          ...
          child: Column(
            children: [
              ...
              Text(
                ...
                style: (isMobile ? AppTextStyles.displayMedium : AppTextStyles.displayLarge).copyWith(
                  fontWeight: FontWeight.w900,
                  height: 1.25,
                ),
              ),
                ...
                children: [
                  ElevatedButton(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Icon(Icons.add_task_rounded, color: Color(0xFF090D16), size: 20),
                        const SizedBox(width: 10),
                        Text(
                          'اطلب فني الآن',
                  ...
                  OutlinedButton(
                    ...
                    child: Row(
                      mainAxisSize: MainAxisSize.min,
                      children: [
                        const Icon(Icons.engineering_rounded, color: AppColors.gold, size: 20),
                        const SizedBox(width: 10),
                        Text(
                          'انضم كـ فني (حرفي)',
                          style: AppTextStyles.titleLarge.copyWith(
...
class _ServiceCard extends StatelessWidget {
  ...
  IconData _getServiceVectorIcon(ServiceType service) {
    switch (service) {
      case ServiceType.plumbing: return Icons.plumbing_rounded;
      case ServiceType.electricity: return Icons.bolt_rounded;
      case ServiceType.ac: return Icons.ac_unit_rounded;
      case ServiceType.painting: return Icons.format_paint_rounded;
      case ServiceType.carpentry: return Icons.handyman_rounded;
      case ServiceType.appliances: return Icons.kitchen_rounded;
    }
  }
            ...
            children: [
              Row(
                children: [
                  ...
                  Container(
                    ...
                    child: Text(
                      'معتمد ⚡',
                      style: AppTextStyles.labelMed.copyWith(color: AppColors.success),
                    ),
                  ),
                ],
              ),
              ...
              Row(
                children: [
                  ...
                  const SizedBox(width: 6),
                  const Icon(Icons.arrow_back_rounded, size: 16, color: AppColors.gold),
                ],
              ),
            ],
          ),
              ...
              Wrap(
                ...
                children: const [
                  _StepCard(
                    ...
                    description: 'اختر نوع الصيانة المطلوبة وموقعك لتوصيلك بأقرب فني معتمد.',
                  ),
                  _StepCard(
                    stepNumber: '02',
                    icon: Icons.badge_rounded,
                    title: 'تأكيد وحضور الفني',
                    description: 'يتم إسناد طلبك فوراً وتأكيد الموعد والتواصل المباشر مع الفني.',
                  ),
                  _StepCard(
                    stepNumber: '03',
                    icon: Icons.verified_user_rounded,
                    title: 'إتمام وإستلام بالضمان',
                    description: 'انجاز العمل بأسعار عادلة واستلام ضمان معتمد من منصة حرفي.',
                  ),
                ],
              ),
            ],
              ...
              Wrap(
                ...
                children: const [
                  _FeatureItem(
                    ...
                    description: 'جميع الفنيين يخضعون لفحص جنائي واختبار مهارة دقيق قبل الانضمام.',
                  ),
                  _FeatureItem(
                    icon: Icons.request_quote_rounded,
                    title: 'تسعير شفاف وعادل',
                    description: 'أسعار محددة مسبقاً وتكاليف عادلة بدون أي رسوم خفية أو مفاجآت.',
                  ),
                  _FeatureItem(
                    icon: Icons.shield_outlined,
                    title: 'ضمان حقيقي معتمد',
                    description: 'ضمان شامل على قطع الغيار وجودة العمل لإعادة الإصلاح مجاناً إذا لزم الأمر.',
                  ),
                  _FeatureItem(
                    icon: Icons.headset_mic_rounded,
                    title: 'دعم وتتبع مباشر',
                    description: 'خدمة عملاء وتتبع حاد للطلب من وقت الحجز وحتى استلام العمل.',
                  ),
                ],
              ),
            ],
            ...
            child: Flex(
              ...
              children: [
                Expanded(
                  flex: isMobile ? 0 : 1,
                  child: Column(
                    crossAxisAlignment: isMobile ? CrossAlignment.center : CrossAlignment.start,
                    children: [
                      Container(
                ...
                ElevatedButton(
                  ...
                  child: Row(
                    mainAxisSize: MainAxisSize.min,
                    children: [
                      const Icon(Icons.engineering_rounded, color: Color(0xFF090D16), size: 22),
                      const SizedBox(width: 10),
                      Text(
                        'سجل كفني الآن',
                        style: AppTextStyles.titleLarge.copyWith(
                  ...
                  Row(
                    children: [
                      Container(
                        ...
                        child: const Icon(Icons.handyman_rounded, size: 18, color: Color(0xFF090D16)),
                      ),
                      const SizedBox(width: 8),
                      Text(
